...
public class Main {
    public static void main(String[] args) {
        ...
        Menu hanburgers = new Menu("Burgers", Arrays.asList(
        ...
        Menu drinks = new Menu("Drinks", Arrays.asList(
                new MenuItem("사이다", 1500),
        ...
        Menu SideMenu = new Menu("SideMenu", Arrays.asList(
                new MenuItem("감자튀김", 3000, "강원도 햇감자로 튀긴 감자튀김"),
